...
<head>
    <meta charset="UTF-8">
    <title>Réinitialiation du mot de passe</title>
...
<body>
    <main class="container wrapper">
        <section>
            ...
            <p>Veuillez remplir ceci pour réinitialiser votre mot de passe.</p>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-block btn-link bg-light" href="welcome.php">Annuler</a>
                </div>
            </form>
        </section>
    </main>    
